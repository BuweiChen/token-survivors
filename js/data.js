...
const DATA = (() => {
  ...
  const WEAPONS = {
    ...
    embeddings: {
      ...
      base: { dmg: 9, count: 2, radius: 72, rotSpeed: 2.6 },
      lvls: [{ count: 1 }, { dmg: 4 }, { rotSpeed: 0.7 }, { count: 1 }, { dmg: 4 }, { radius: 18 }, { count: 1 }, { dmg: 5, rotSpeed: 0.7 }],
    ...
    gradientDescent: {
      ...
      base: { dmg: 20, cd: 1.7, count: 2, radius: 52 },
      lvls: [{ count: 1 }, { dmg: 6 }, { radius: 10 }, { count: 1 }, { dmg: 7 }, { radius: 12 }, { cd: -0.25 }, { dmg: 8, count: 1 }],
      evolvesWith: 'lora',
      evo: 'gemini',
    },
    toolCall: {
